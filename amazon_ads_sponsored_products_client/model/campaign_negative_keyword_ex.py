...
class CampaignNegativeKeywordEx(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CampaignNegativeKeywordEx - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            keyword_id (float): The identifier of the campaign negative keyword.. [optional]  # noqa: E501
            campaign_id (float): The identifer of the campaign to which the campaign negative keyword is associated.. [optional]  # noqa: E501
            state (str): The campaign negative keyword state.. [optional] if omitted the server will use the default value of "enabled"  # noqa: E501
            ...
            serving_status (str): The serving status of the campaign negative keyword. See the **computed status** section of the [developer notes](https://advertising.amazon.com/API/docs/en-us/get-started/developer-notes) for definitions.. [optional]  # noqa: E501
        """
