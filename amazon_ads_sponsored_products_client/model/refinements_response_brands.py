...
class RefinementsResponseBrands(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """RefinementsResponseBrands - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            id (float): The brand identifier. Note that this is not the same identifier returned from the [getBrands](sponsored-brands/3-0/openapi#/Brands/getBrands) operation.. [optional]  # noqa: E501
            name (str): The brand name.. [optional]  # noqa: E501
        """
