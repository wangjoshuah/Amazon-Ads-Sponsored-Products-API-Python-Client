...
class State(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): The current resource state.., must be one of ["enabled", "paused", "archived", ]  # noqa: E501

        Keyword Args:
            value (str): The current resource state.., must be one of ["enabled", "paused", "archived", ]  # noqa: E501
