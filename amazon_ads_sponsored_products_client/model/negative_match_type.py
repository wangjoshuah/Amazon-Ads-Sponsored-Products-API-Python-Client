...
class NegativeMatchType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """NegativeMatchType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): The type of match. For more information, see [match types](https://advertising.amazon.com/help#GHTRFDZRJPW6764R) in the Amazon Ads support center.., must be one of ["negativeExact", "negativePhrase", ]  # noqa: E501

        Keyword Args:
            value (str): The type of match. For more information, see [match types](https://advertising.amazon.com/help#GHTRFDZRJPW6764R) in the Amazon Ads support center.., must be one of ["negativeExact", "negativePhrase", ]  # noqa: E501
