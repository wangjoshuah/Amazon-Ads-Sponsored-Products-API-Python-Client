...
class MatchType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): The type of match. For more information, see [match types](https://advertising.amazon.com/help#GHTRFDZRJPW6764R) in the Amazon Ads support center.., must be one of ["exact", "phrase", "broad", ]  # noqa: E501

        Keyword Args:
            value (str): The type of match. For more information, see [match types](https://advertising.amazon.com/help#GHTRFDZRJPW6764R) in the Amazon Ads support center.., must be one of ["exact", "phrase", "broad", ]  # noqa: E501
