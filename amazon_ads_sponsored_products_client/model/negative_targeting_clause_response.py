...
class NegativeTargetingClauseResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NegativeTargetingClauseResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            code (str): An enumerated response code.. [optional]  # noqa: E501
            details (str): A human-readable description of the value in the `code` field.. [optional]  # noqa: E501
            description (str): A human-readable description of the value in the `code` field.. [optional]  # noqa: E501
        """
