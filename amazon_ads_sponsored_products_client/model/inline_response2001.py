...
class InlineResponse2001(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            report_id (str): The unique ID for your requested report.. [optional]  # noqa: E501
            record_type (str): The record type of the report. It can be `campaign`, `adGroup`, `keyword`, `productAd`, or `targets`.. [optional]  # noqa: E501
            status (str): The status of the report. Status is one of `IN_PROGRESS`, `SUCCESS`, or `FAILURE`.. [optional]  # noqa: E501
            status_details (str): Description of the status.. [optional]  # noqa: E501
        """
