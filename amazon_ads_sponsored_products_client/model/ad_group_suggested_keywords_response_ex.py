...
class AdGroupSuggestedKeywordsResponseEx(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AdGroupSuggestedKeywordsResponseEx - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            keyword_text (str): The suggested keyword.. [optional]  # noqa: E501
            match_type (MatchType): [optional]  # noqa: E501
            state (str): The state of the ad for which the keyword is suggested.. [optional]  # noqa: E501
            bid (float): The suggested bid for the suggested keyword. Note that this field will not be included in the response if the `suggestBids` query parameter is set to `no` in the request.. [optional]  # noqa: E501
        """
